...
This function aggregates three signal scores with different weight. LLM judgment is most reliable (40%), stylometry is established (35%), perplexity is calibration-dependent (25%).
